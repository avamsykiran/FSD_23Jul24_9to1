...
import { createAddContactAction, createUnEditContactAction, createUpdateContactAction } from '../state/contactsActions';
...
const ContactForm = ({ c }) => {
    ...
    const formSubmitted = event => {
        ...
        let contact = { id, fullName, mobile, mailId, dob };
    ...
    const formReset = event => {
        isEditable ? dispatch(createUnEditContactAction(id)) : clearAll();
    };
